 ...
 * 定位
 */
public class JhLocation extends XtomObject implements AMapLocationListener,
OnGeocodeSearchListener {
	private LocationManagerProxy mAMapLocationManager;
	private AMapLocation aMapLocation;
	private GeocodeSearch geocodeSearch;
	private static JhLocation location;
	...
	public static JhLocation getInstance() {
		if (location == null)
			location = new JhLocation();
		return location;
	}
	...
	// Hm5mApplication application = Hm5mApplication.getInstance();
