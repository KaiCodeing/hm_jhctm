...
import com.hemaapp.jhctm.activity.CarOrderConfirmActivity;
import com.hemaapp.jhctm.adapter.BuyCarAdapter;
 ...
 * 购物车
 */
public class BuyCarFragment extends JhFragment {
...
//       inIt();
    ...
    private void freshData() {
        if (adapter == null) {
            adapter = new BuyCarAdapter(BuyCarFragment.this, cartItemses);
    ...
    protected void setListener() {
        ...
        buy_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getActivity(), CarOrderConfirmActivity.class);
    ...
    private void showView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.pop_left_right_view, null);
