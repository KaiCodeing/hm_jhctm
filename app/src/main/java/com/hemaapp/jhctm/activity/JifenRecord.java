...
import com.hemaapp.jhctm.adapter.JFRecordAdapter;
 ...
 * 积分明细
 */
public class JifenRecord extends JhActivity {
    ...
    private JFRecordAdapter adapter;
    ...
    private void inIt() {
        ...
        getNetWorker().score_list(token, String.valueOf(page));
    }
    ...
    private void freshData() {
        if (adapter == null) {
            adapter = new JFRecordAdapter(mContext, replies);
