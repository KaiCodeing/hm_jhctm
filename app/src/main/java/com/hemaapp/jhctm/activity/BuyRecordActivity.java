...
import com.hemaapp.jhctm.adapter.BuyRecordAdapter;
 ...
 * 购买记录
 */
public class BuyRecordActivity extends JhActivity {
    ...
    private void inIt()
    {
        ...
        getNetWorker().goldScoreBuyList(token,String.valueOf(page));
    }
    @Override
    protected void callBeforeDataBack(HemaNetTask hemaNetTask) {
        JhHttpInformation information = (JhHttpInformation) hemaNetTask.getHttpInformation();
        switch (information) {
            case GOLD_SCORE_BUY_LIST:
    ...
    private void freshData() {
        if (adapter == null) {
            adapter = new BuyRecordAdapter(mContext, replies);
    ...
    protected void callBackForGetDataFailed(HemaNetTask hemaNetTask, int i) {
        ...
        switch (information) {
            case GOLD_SCORE_BUY_LIST:
                ...
                showTextDialog("获取平台购买记录失败，请稍后重试");
                break;
        }
    }
