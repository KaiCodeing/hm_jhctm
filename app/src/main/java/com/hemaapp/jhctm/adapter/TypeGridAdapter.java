 ...
 */
public class TypeGridAdapter extends HemaAdapter {
    private ArrayList<DistrictInfor> districtInfors;
    private String type;
    private TypeSelectPopActivity mContext;

    public TypeGridAdapter(TypeSelectPopActivity mContext, ArrayList<DistrictInfor> districtInfors, String type) {
        super(mContext);
    ...
    private void setData(ViewHolder holder, int position) {
        DistrictInfor districtInfor = districtInfors.get(position);
