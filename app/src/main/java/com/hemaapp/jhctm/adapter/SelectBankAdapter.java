...
import com.hemaapp.jhctm.activity.SelectBankActivity;
...
public class SelectBankAdapter extends HemaAdapter {
    ...
    public SelectBankAdapter(SelectBankActivity mContext, ArrayList<Bank> banks) {
        super(mContext);
