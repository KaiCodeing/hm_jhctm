...
import com.hemaapp.jhctm.activity.CarBuyActivity;
 ...
 * 购物车activity的adapter
 */
public class CarBuyAdapter extends HemaAdapter {
    private ArrayList<CartItems> cartItemses;
    private CarBuyActivity activity;

    public CarBuyAdapter(CarBuyActivity activity, ArrayList<CartItems> cartItemses) {
        super(activity);
    ...
    private void setData(ViewHolder holder, int position) {
        ...
        holder.subtarct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (itemses.getBuycount().equals("1")) {
                    ...
                    activity.changeNum(itemses.getId(), String.valueOf(num), "3");
                }
        ...
        holder.check_select_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CartItems itemses = (CartItems) v.getTag(R.id.TAG);
                activity.selectCart(Integer.valueOf(itemses.getId()));
            }
        });
