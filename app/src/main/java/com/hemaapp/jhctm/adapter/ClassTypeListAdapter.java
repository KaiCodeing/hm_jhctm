 ...
 */
public class ClassTypeListAdapter extends HemaAdapter {
    private ArrayList<DistrictInfor> infors;
    private ClassTypeFragment activity;

    public ClassTypeListAdapter(ClassTypeFragment activity, ArrayList<DistrictInfor> infors) {
        super(activity);
