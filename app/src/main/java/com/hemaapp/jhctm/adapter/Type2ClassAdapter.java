 ...
 */
public class Type2ClassAdapter extends HemaAdapter {
    private ArrayList<DistrictInfor> infors;
    private YiWuDuiActivity activity;

    public Type2ClassAdapter(YiWuDuiActivity activity, ArrayList<DistrictInfor> infors) {
        super(activity);
